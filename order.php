        ...
        <div class="ecom-contenthny py-5">
            <div class="container py-lg-5">
                ...
                <div class="ecom-contenthny-w3lcheckout privacy">
                    ...
                    <?php
                    $query_order = mysqli_query($connection,"SELECT * FROM `tbl_order` where `user_id` ='{$_SESSION['userid']}' order by order_id desc");
                        ...
                        <table class="timetable_sub">
                            ...
                            <tbody>
                                ...
                                <tr class="rem1">
                                 ...
                                 <td><a href="order-view.php?id=<?php echo $row["order_id"];?>" class="btn btn-secondary">View Order</a></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
