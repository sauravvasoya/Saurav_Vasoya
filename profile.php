            ...
            <div class="contact-right mt-lg-4">
                <form action="https://sendmail.w3layouts.com/submitForm" method="post" class="signin-form">
                    <div class="input-grids">
                        ...
                        <!-- <select name="service" id="w3lName" class="contact-input">
                        ...
                        <input type="text" name="w3lName" id="w3lName" placeholder="Your Name" pattern="^[A-Za-z -]+$"  title="Please Enter Only Characters" minlength="3" class="contact-input" required="true">
                        <input type="email" name="w3lName" id="w3lName" placeholder="E-mail"   class="contact-input" required="true">
                        <input type="text" name="w3lPhone" id="w3lPhone" placeholder="Enter your Phone Number " maxlength="10" minlength="10" pattern="[0-9]{10}" title="please enter valid Mobile Number" required="">
                        <input type="text" name="w3lSubect" id="w3lSubect" placeholder="Address" class="contact-input" required="">
                    </div>
                    <!-- <div class="form-input">
                        <textarea name="w3lMessage" id="w3lMessage" placeholder="Type your issue with the product here*" required=""></textarea>
                    </div> -->
                    <div class="submit-w3l-button text-lg-right">
                    <button class="btn btn-style btn-primary" >Edit Profile</button>
                    <!-- href="payment.php" -->
                    </div>
                </form>
            </div>
