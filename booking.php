                ...
                <div class="w3breadcrumb-gids">
                    ...
                    <div class="w3breadcrumb-right">
                        <ul class="breadcrumbs-custom-path">
                            ...
                            <li class="active"><span class="fas fa-angle-double-right mx-2"></span> Your Booking </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <table class="timetable_sub">
                            ...
                            <tbody>
                                <tr class="rem1">
                                    ...
                                    <td class="invert">Voltas Split AC</td>

                                    <td class="invert">₹1000</td>
                                   
                                </tr>
                                <tr class="rem2">
                                    <td class="invert">2</td>
                                    <td class="invert-image"><a href="product-single.php"><img src="assets/images/shop-2.jpg" class="img-fluid radius-image" alt=""></a></td>
                                    <td class="invert">
                                        <div class="quantity">
                                            <div class="quantity-select">
                                    ...
                                    <td class="invert">Voltas Window AC</td>

                                    <td class="invert">₹800</td>
                                    
                                </tr>
                                <tr class="rem3">
                                    <td class="invert">3</td>
                                    <td class="invert-image"><a href="product-single.php"><img src="assets/images/shop-3.jpg" class="img-fluid radius-image" alt=""></a></td>
                                    <td class="invert">
                                        <div class="quantity">
                                            <div class="quantity-select">
                                                
                                                <p> Water Tank problem</p>

                                            </div>
                                        </div>
                                    </td>
                                    <td class="invert">Croma Portable AC</td>
