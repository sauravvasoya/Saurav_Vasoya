        ...
        <div class="container py-lg-4 py-md-3 py-2">
            ...
            <div class="contact-grids mt-5 pt-lg-3">
                ...
                <div class="contact-right mt-lg-4">
                    <form action="#" method="post" id="myform" class="signin-form">
                        <div class="input-grids">
                            <input type="text" name="w3lName" id="w3lName" pattern="^[A-Za-z -]+$" minlength="3" placeholder="Your Name*" class="contact-input" required="">
                            <input type="email" name="w3lSender" id="w3lSender" placeholder="Your Email*" class="contact-input" required="">
                            <input type="text" name="w3lPhone" id="w3lPhone" maxlength="10" minlength="10" pattern="[0-9]{10}" placeholder="Enter your Phone Number *" required="">
