...
session_start();
        ...
        require 'connection.php';
            ...
            if ($_POST) {
                $mail = $_POST['email'];
                $pass = $_POST['password'];
                $query = mysqli_query($connection, "select * from tbl_usermaster where email = '{$mail}' and password='{$pass}'");
            ...
            <div class="form-wrapv">
                ...
                <form action="login.php" id="myform" method="post">
                    <div class="form-sub-w3">
                        <input type="email" name="email" placeholder="Email " minlength="3" required="true" />
                        <div class="icon-w3">
                            <span class="fas fa-user" aria-hidden="true"></span>
                        </div>
                    </div>
                    <div class="form-sub-w3">
                        <input type="password" name="password" maxlength="8" minlength="6" placeholder="Password" required="true" />
                        <div class="icon-w3">
